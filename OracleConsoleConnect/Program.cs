...
namespace OracleEFCore6
{
    class Program
    {
        ...
        public class BloggingContext : DbContext
        {
            ...
            {
                optionsBuilder.UseOracle(@"User Id=blog;Password=dotchka1SS;Data Source=(DESCRIPTION=(ADDRESS_LIST=(ADDRESS=(PROTOCOL=TCP)(HOST=localhost)(PORT=1521)))(CONNECT_DATA=(SERVER=DEDICATED)(SERVICE_NAME= pdb1.mshome.net)))");
            }
        }
